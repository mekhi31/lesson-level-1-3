...
## Project outline and details
  1. Project name:my website about jordan sneaker
  2. What kind (static website, game, mobile web app, etc.) of project is this:web application
  3. What is this project about (please be detailed):this project is for jordan fans
  4. What research (do you need to learn about a person, find images, etc.) do you need to do for this project: pictures, description of shoes, where you can by the shoes, and pricing.
